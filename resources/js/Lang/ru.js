export default {
    ...
    admin: {
        ...
        common: {
            ...
            filterAllFields: 'Фильтр: все поля',
        ...
        form: {
            ...
            modeCreate: 'Новая запись',
            modeEdit: 'Редактирование',
            createDescription: 'Заполните поля и создайте новую запись в выбранной таблице.',
            editDescription: 'Изменения сохранятся сразу в таблицу после отправки формы.',
            fieldsTitle: 'Поля записи',
            fieldsDescription: 'Типы и обязательность полей берутся из структуры таблицы.',
            fieldsCount: 'полей',
        ...
        columns: {
            ...
            size: 'Размер',
            color_dark: 'Темный цвет',
            color_light: 'Светлый цвет',
            is_dynamic: 'Динамический',
            slug: 'Slug',
            scan_count: 'Сканирований',
            ip: 'IP',
