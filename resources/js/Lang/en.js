export default {
    ...
    admin: {
        ...
        form: {
            ...
            modeCreate: 'New record',
            modeEdit: 'Editing',
            createDescription: 'Fill in the fields and create a new record in the selected table.',
            editDescription: 'Changes will be saved directly to the table after submitting the form.',
            fieldsTitle: 'Record fields',
            fieldsDescription: 'Field types and required state are taken from the table schema.',
            fieldsCount: 'fields',
            required: 'required',
            enabled: 'Enabled',
            disabled: 'Disabled',
