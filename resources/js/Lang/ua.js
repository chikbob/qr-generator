export default {
    ...
    admin: {
        ...
        form: {
            ...
            modeCreate: 'Новий запис',
            modeEdit: 'Редагування',
            createDescription: 'Заповніть поля та створіть новий запис у вибраній таблиці.',
            editDescription: 'Зміни будуть збережені одразу в таблицю після відправлення форми.',
            fieldsTitle: 'Поля запису',
            fieldsDescription: 'Типи та обов\'язковість полів беруться зі структури таблиці.',
            fieldsCount: 'полів',
